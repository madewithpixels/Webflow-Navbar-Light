...
- Both published loader elements reported `data-mwp-status="loaded"`, version `0.2.0`, `crossorigin="anonymous"` and the committed SHA-384 integrity values.
