...
- [ ] Build the cascade correction into a new semantic version, regenerate matching distribution files and integrity metadata, and verify a fresh CDN installation before updating either Library edition.
